...
## What is R
**R** is a type of programming language and supports many tasks including statistical computation and grapics.

## What is R Studio
**RStudio** is a programming software for editing and running R code.
...
R could be downloaded [here](https://www.r-project.org/) and RStudio could be downloaded [here](https://www.rstudio.com/products/rstudio/download/).
...
3. **Environment/History** Environment lists all the variables that you are using. History presents the codes you have runned before.
4. **Console** Console is original R interactive window. You could input codes and see the results here.
...
## Print Hello, world
Now, let's try to input some codes and run them! Let's let R print the very classic "Hello, world!" with ``print()`` function.
...
Some packages have been already been installed and you could use them directly. However, most of the packages have to be installed before you want to use them. There are couple of ways you could install a package. Let's take the ``gbm`` package for example.
```
