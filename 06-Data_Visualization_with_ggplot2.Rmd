...
In this plot, it shows clearly the temporal trend of the number of unemployed population in the US. There two increase recently starting from 2001 and 2008, which match two economic risks in around 2001 and 2008.
...
What``ggplot2`` does here to draw a bar plot is to create a bar plot first.
