...
Geospatial datasets have two main formats: one is vector, the other is raster. Here is the [link](https://umar-yusuf.blogspot.com/2016/05/working-with-vector-and-raster-data-in.html) to show their differences. Vetor data is a combination of points, lines, and polygons. Raster data is a combination of grids or cells with different values. In this chapter, we will focus on the vetor part. For example, the shapefile (.shp) format is a commonly used geospatial vetor format.
