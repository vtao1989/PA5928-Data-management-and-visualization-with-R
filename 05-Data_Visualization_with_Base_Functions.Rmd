...
We would go through the base plotting functions in R first in this chapter.
...
```{r}
t <- c(1, 5, 10, 7, 8, 10, 11, 19)
boxplot(t, range = 1) # set range = 1 makes the the whiskers extend to
                      # the most extreme data point which is no more than range times
